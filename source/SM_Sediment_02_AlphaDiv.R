...
######| Warm ####
alpha.div.warm<- plot_richness(ps_sed_Warm, x="Time", measures= "Shannon")
...
######| Cold ####
alpha.div.cold<- plot_richness(ps_sed_Cold, x="Time", measures= "Shannon")
...
ggsave(here("Results_W&C","Figures","SupFig_SedimentAlphaDiv.pdf"), 
       plot = Alpha ,
       device='pdf',height = 7.5, width = 10.5)

ggsave(here("Results_W&C","Figures","SupFig_SedimentAlphaDiv.png"), 
       plot = Alpha, 
       device='png',height = 7.5, width = 10.5)
