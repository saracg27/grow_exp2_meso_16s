...
######| Warm ####
alpha.div.warm<- plot_richness(ps_water_18S_Warm, x="Time", measures= "Shannon")
...
######| Cold ####
alpha.div.cold<- plot_richness(ps_water_18S_Cold, x="Time", measures= "Shannon")
...
ggsave(here("Results_W&C","Figures","SupFig_Water18SAlphaDiv.pdf"), 
       plot = Alpha ,
       device='pdf',height = 7.5, width = 10.5)

ggsave(here("Results_W&C","Figures","SupFig_Water18SAlphaDiv.png"), 
       plot = Alpha, 
       device='png',height = 7.5, width = 10.5)
