...
meta_w <- meta_sorted[meta_sorted$Temperature == "warm",] # 68 obs in warm
...
sum(colsums_phylum$`colSums(phylum_w)` == 0) # 0 phylum have a relative abundance of 0 in w warm  samples
abund <- as.data.frame(phylum[, colMeans(phylum) > 0.01]) # 6
...
Only 6 phyla/groups had a relative abundance higher than 1%: Actinomycetota, Bacteroidota,  Cyanobacteria, Planctomycetota and Proteobacterial classes Alphaproteobacteria and Gammaproteobacteria. 

### Bind treatments and abundances
```{r}
rownames(abund) == rownames(meta_w)
abund_treat <- cbind(meta_w,abund)
dim(abund_treat) # 68 13
```

### Gather in long format for ggplot

```{r}
long <- gather(abund_treat,Taxa,RelAbund,7:ncol(abund_treat)) #change the column index value to match the first column that contains a Taxa name and not a treatment
...
stack_phylum_warm
# Save plots
# ggsave(file = here::here("output", "figures", "relAbund_phylum_16S_water_16S-warm.pdf"), stack_phylum_warm, width = 7, height = 4, units = "in", dpi = 300,bg = "white")
# ggsave(file = here::here("output", "figures", "relAbund_phylum_16S_water_16S-warm.eps"), stack_phylum_warm, width = 6, height = 4, units = "in", dpi = 300,bg = "white")
# ggsave(file = here::here("output", "figures", "relAbund_phylum_16S_water_16S-warm.png"), stack_phylum_warm, width = 6, height = 4, units = "in", dpi = 300,bg = "white")
```

## Wrangling GENUS
```{r}
#Subset Water dataset to keep only warm
genus_w <- genus_sorted[rownames(genus_water_16S) %in% rownames(meta_w),]
# Check rownames
rownames(genus_w) == rownames(meta_w)
## Keep only present genera and phyla
genus_w_abund <- genus_w[, (colSums(genus_w) > 0)] # 68 415
dim(genus_w_abund)
```
...
sum(colsums_genus$`colSums(genus_w)` == 0) # 15 genera have a relative abundance of 0 in w  samples
genus <- genus_w[, colSums(genus_w) != 0] # drop genera that are not present in w samples
dim(genus) #  68 415
abund <- as.data.frame(genus[, colMeans(genus) > 0.005]) # 37 genera with a relative abundance over 0.5%
abund <- as.data.frame(genus[, colMeans(genus) > 0.01]) # 22 genera with a relative abundance over 1%
abund$Others = 1 - rowSums(abund)#Add an "Other" category
```
...
genus_long$Taxa <- fct_relevel(genus_long$Taxa, "uncultured *Comamonadaceae*", after = 1L)
...
stack_genus_warm
# Save plots
# ggsave(file = here::here("output", "figures", "relAbund_genus_16S_water_16S-warm.pdf"), stack_genus_warm, width = 7, height = 7, units = "in", dpi = 300,bg = "white")
# ggsave(file = here::here("output", "figures", "relAbund_genus_16S_water_16S-warm.eps"), stack_genus_warm, width = 7, height = 7, units = "in", dpi = 300,bg = "white")
# ggsave(file = here::here("output", "figures", "relAbund_genus_16S_water_16S-warm.png"), stack_genus_warm, width = 7, height = 7, units = "in", dpi = 300,bg = "white")
```
...
p1
# Save plots
# ggsave(file = here::here("output", "figures", "relAbund_genus_16S_water_16S_lolipops-warm.pdf"), p1, width = 6, height = 6, units = "in", dpi = 300,bg = "white")
# ggsave(file = here::here("output", "figures", "relAbund_genus_16S_water_16S_lolipops-warm.eps"), p1, width = 6, height = 6, units = "in", dpi = 300,bg = "white")
# ggsave(file = here::here("output", "figures", "relAbund_genus_16S_water_16S_lolipops-warm.png"), p1, width = 6, height = 6, units = "in", dpi = 300,bg = "white")
```
...
meta_c <- meta_sorted[meta_sorted$Temperature == "cold",] # 39 obs in cold
...
Only 5 phyla/groups had a relative abundance higher than 1%: Actinobacteriota, Bacteroidota,  Planctomycetota, and Pseudomonadota classes Alphaproteobacteria and Gammaproteobacteria. 
...
stack_phylum_cold
# Save plots
# ggsave(file = here::here("output", "figures", "relAbund_phylum_16S_water_16S-cold.pdf"), stack_phylum_cold, width = 7, height = 4, units = "in", dpi = 300,bg = "white")
# ggsave(file = here::here("output", "figures", "relAbund_phylum_16S_water_16S-cold.eps"), stack_phylum_cold, width = 7, height = 4, units = "in", dpi = 300,bg = "white")
# ggsave(file = here::here("output", "figures", "relAbund_phylum_16S_water_16S-cold.png"), stack_phylum_cold, width = 7, height = 4, units = "in", dpi = 300,bg = "white")
```
...
genus_c_abund <- genus_c[, (colSums(genus_c) > 0)] # 71 385
dim(genus_c_abund)
```
...
sum(colsums_genus$`colSums(genus_c)` == 0) # 45 genera have a relative abundance of 0 in w  samples
...
```{r}
genus_long$Taxa <- fct_relevel(genus_long$Taxa, "*Others*", after = 0L)
genus_long$Taxa <- fct_relevel(genus_long$Taxa, "*Polynucleobacter*", after = 1L)
genus_long$Taxa <- fct_relevel(genus_long$Taxa, "uncultured *Isosphaeraceae*", after = 2L)
genus_long$Taxa <- fct_relevel(genus_long$Taxa, "uncultured *Rhodobacteraceae*", after = 3L)
genus_long$Taxa <- fct_relevel(genus_long$Taxa, "uncultured *Comamonadaceae*", after = Inf)
```
...
stack_genus_cold
# Save plots
# ggsave(file = here::here("output", "figures", "relAbund_genus_16S_water_16S-cold.pdf"), stack_genus_cold, width = 7, height = 7, units = "in", dpi = 300,bg = "white")
# ggsave(file = here::here("output", "figures", "relAbund_genus_16S_water_16S-cold.eps"), stack_genus_cold, width = 7, height = 7, units = "in", dpi = 300,bg = "white")
# ggsave(file = here::here("output", "figures", "relAbund_genus_16S_water_16S-cold.png"), stack_genus_cold, width = 7, height = 7, units = "in", dpi = 300,bg = "white")
```
...
p1
# Save plots
# ggsave(file = here::here("output", "figures", "relAbund_genus_16S_water_16S_lolipops-cold.pdf"), p1, width = 6, height = 6, units = "in", dpi = 300,bg = "white")
# ggsave(file = here::here("output", "figures", "relAbund_genus_16S_water_16S_lolipops-cold.eps"), p1, width = 6, height = 6, units = "in", dpi = 300,bg = "white")
# ggsave(file = here::here("output", "figures", "relAbund_genus_16S_water_16S_lolipops-cold.png"), p1, width = 6, height = 6, units = "in", dpi = 300,bg = "white")
```
