...
## DESeq2 genus
```{r}
# Subset the original phyloseq object 'ps_taxa' to only include samples from time points "D4" and "D20"
ps_taxa_sub <- subset_samples(ps_taxa, Time %in% c("D4", "D20")) # 48 samples
...
ps_taxa_pse_sub <- prune_taxa(rowSums(otu_table(ps_taxa_sub) == 0) < ncol(otu_table(ps_taxa_sub)) * 0.9, ps_taxa_sub) # 436
...
ann_colors = list(
    ...
    `Time` = c(D4 = "purple", D20 = "yellow"),
    Phylum = phylum_col
)
png(here("output", "figures","heatmap_D4-D20-on-sediments.png"),width=8,height=4,units="in",res=600)
...
volcano_sed_4.20_genus <- EnhancedVolcano(res_volcano, 
                          lab = res_volcano$Genus, 
                          x = 'log2FoldChange', 
                          y = "padj",
                          title = "",
                          subtitle = "D4 vs D20 in Sediments - Genus",
                          pointSize = 4.0,
                          labSize = 3.0,
                          colAlpha = 0.5,
                          legendPosition = 'top',
...
volcano_sed_4.20_genus

ggsave(filename = here("output", "figures", "deseq_volcano_sed_4.20_genus.png"), plot = volcano_sed_4.20_genus, width = 6, height = 6, dpi = 300)
ggsave(filename = here("output", "figures", "deseq_volcano_sed_4.20_genus.pdf"), plot = volcano_sed_4.20_genus, width = 6, height = 6, dpi = 300)
...
ps_taxa_sub <- subset_samples(ps_taxa, Time %in% c("D4", "D20"))
...
volcano_sed_4.20_order <- EnhancedVolcano(res_volcano, 
                          ...
                          y = "padj",
                          title = "",
                          subtitle = "D4 vs D20 in Sediments - Order",
                          pointSize = 4.0,
                          labSize = 3.0,
                          colAlpha = 0.5,
                          legendPosition = 'top',
