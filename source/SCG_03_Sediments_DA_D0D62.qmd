...
raw <- raw[, colnames(raw) != '223.224MesoRh.4.1G.E2.16S.D66'] # 20063 283
...
# -------------------------------------------------------
Load next chunk if running this script from here
```{r}
...
volcano_sed_0.62_genus <- EnhancedVolcano(res_volcano, 
                          lab = res_volcano$Genus, 
                          x = 'log2FoldChange', 
                          y = "padj",
                          title = "",
                          subtitle = "D0 vs D62 in Sediments - Genus",
                          pointSize = 4.0,
                          labSize = 3.0,
                          colAlpha = 0.5,
                          legendPosition = 'top',
...
volcano_sed_0.62_genus

saveRDS(volcano_sed_0.62_genus, file = here("RData", "deseq2_volcano_sed_0.62_genus.rds"))
ggsave(filename = here("output", "figures", "deseq_volcano_sed_0.62_genus.png"), plot = volcano_sed_0.62_genus, width = 6, height = 6, dpi = 300)
ggsave(filename = here("output", "figures", "deseq_volcano_sed_0.62_genus.pdf"), plot = volcano_sed_0.62_genus, width = 6, height = 6, dpi = 300)
