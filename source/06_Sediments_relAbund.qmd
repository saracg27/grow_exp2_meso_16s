...
# Save plots
ggsave(file = here::here("output", "figures", "relAbund_genus_16S_sediments_pops.pdf"), p1, width = 7, height = 7, units = "in", dpi = 300,bg = "white")
ggsave(file = here::here("output", "figures", "relAbund_genus_16S_sediments_pops.eps"), p1, width = 7, height = 7, units = "in", dpi = 300,bg = "white")
