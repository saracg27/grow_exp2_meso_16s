...
write.table(Permanova.Warm.rclr,row.names=T,sep=";",
            here("Results_W&C","Tables","Root_Warm_RCLR_Permanova.csv"))
...
RCLR_ord_plant_Warm <- phyloseq::plot_ordination(ps_Warm_rclr, ord_Warm_rclr, type="samples",shape="Plant.type",color="Plant.type") + 
    ...
    #ggtitle(label = "rootiments - Robust Aitchison distance")+
...
# ggsave(here("Results_W&C","Figures","root_Warm_RCLR_Ordination.pdf"),device='pdf',height = 7.5, width = 10.5)
# ggsave(here("Results_W&C","Figures","root_Warm_RCLR_Ordination.png"),device='png',height = 7.5, width = 10.5)
...
Pairwise.Time<- pairwise.adonis(rclr_dist_matrix, 
                                ...
                                p.adjust.m ="fdr")
Pairwise.Time
# D62 significantly different from D0 , D10, D16
...
write.table(Permanova.Cold.rclr,row.names=T,sep=";",
            here("Results_W&C","Tables","Root_Cold_RCLR_Permanova.csv"))
...
# ggsave(here("Results_W&C","Figures","root_Cold_RCLR_Ordination.pdf"),device='pdf',height = 7.5, width = 10.5)
# ggsave(here("Results_W&C","Figures","root_Cold_RCLR_Ordination.png"),device='png',height = 7.5, width = 10.5)


####^Common plot ####
RCLR_WC <- ggarrange(RCLR_Warm,RCLR_Cold,
                     nrow=2)
ggsave(here("Results_W&C","Figures","Root_W&C_RCLR_Ordination.pdf"),
       plot=RCLR_WC, device='pdf',height = 7.5, width = 10.5)

ggsave(here("Results_W&C","Figures","Root_W&C_RCLR_Ordination.png"),
