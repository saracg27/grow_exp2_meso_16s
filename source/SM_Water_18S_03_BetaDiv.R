...
write.table(Permanova.Warm.rclr,row.names=T,sep=";",
            here("Results_W&C","Tables","Water_18S_Warm_RCLR_Permanova.csv"))
...
write.table(Pairwise_relevant_PTxTime,row.names=T,sep=";",here("Results_W&C","Tables","water_18S_Warm_RCLR_PWP_PTxTime.csv"))
...
RCLR_ord_plant_Warm <- phyloseq::plot_ordination(ps_Warm_rclr, ord_Warm_rclr, type="samples",shape="Sample_type",color="Sample_type") + 
    ...
    #ggtitle(label = "water_18Siments - Robust Aitchison distance")+
...
# ggsave(here("Results_W&C","Figures","water_18S_Warm_RCLR_Ordination.pdf"),device='pdf',height = 7.5, width = 10.5)
# ggsave(here("Results_W&C","Figures","water_18S_Warm_RCLR_Ordination.png"),device='png',height = 7.5, width = 10.5)
...
write.table(Permanova.Cold.rclr,row.names=T,sep=";",
            here("Results_W&C","Tables","Water_18S_Cold_RCLR_Permanova.csv"))
...
write.table(Pairwise_relevant_PTxTime,row.names=T,sep=";",here("Results_W&C","Tables","Water_18S_Cold_RCLR_PWP_PTxTime.csv"))
...
# ggsave(here("Results_W&C","Figures","water_18S_Cold_RCLR_Ordination.pdf"),device='pdf',height = 7.5, width = 10.5)
# ggsave(here("Results_W&C","Figures","water_18S_Cold_RCLR_Ordination.png"),device='png',height = 7.5, width = 10.5)
...
Pairwise.Time<- pairwise.adonis(rclr_dist_matrix, 
                                ...
                                p.adjust.m ="fdr")
Pairwise.Time
# All sampling times are different from one another except D77 vs D62


####^Common plot ####
RCLR_WC <- ggarrange(RCLR_Warm,RCLR_Cold,
                     nrow=2)
ggsave(here("Results_W&C","Figures","Water_18S_W&C_RCLR_Ordination.pdf"),
       plot=RCLR_WC, device='pdf',height = 7.5, width = 10.5)

ggsave(here("Results_W&C","Figures","Water_18S_W&C_RCLR_Ordination.png"),
